...
# Enteros con guion bajo para legibilidad (Python 3.6+)
print(11111111)
print(11_111_111)   # mismo valor, mas legible

# Numeros negativos y positivos
print(-11_111_111)
print(+11111111)

# Numeros octales (prefijo 0o)
print(0o123)   # equivale a 83 en decimal

# Numeros hexadecimales (prefijo 0x)
...
print(4.)      # el cero despues del punto es opcional

# Notacion cientifica
print(3E8)          # velocidad de la luz: 300,000,000
print(6.62607E-34)  # Constante de Planck

# Python elige la representacion mas corta
...
# Usando apostrofes como delimitador alternativo
print('Me gusta "Monty Python"')

# Escapando apostrofe dentro de cadena con apostrofes
...
# Los booleanos se comportan como 1 y 0 numericamente
